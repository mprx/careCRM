...
if (isset($_POST["submit"]))
{
  //form handling
    ...
    if (!empty($sw_anrede) && !empty($sw_vorname) && !empty($sw_nachname) && !empty($sw_strasse) && !empty($sw_nr) && !empty($sw_plz))
    {
      ...
      $query = "SELECT sw_id FROM sachwalter WHERE sw_vorname = '$sw_vorname' AND sw_nachname = '$sw_nachname' AND sw_gebdatum = '$sw_gebdatum' AND sw_typ = 'ag' LIMIT 1";
      ...
      if (mysqli_num_rows($data) == 0)
      {
          ...
          if (($sw_mail != "" && filter_var($sw_mail, FILTER_VALIDATE_EMAIL)) || $sw_mail == "")
          {
            ...
            $query = "INSERT INTO sachwalter " .
                     ...
                     "VALUES" .
                     "('$sw_anrede', '$sw_titel', '$sw_vorname', '$sw_nachname', '$sw_gebdatum', '$sw_tel1', '$sw_tel2', '$sw_mail', '$sw_rg', 'ag')";
