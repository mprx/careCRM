...
?>
    <table class="table table-striped table-sm">
        ...
        while($row = mysqli_fetch_array($data))
        {
            ...
            echo '<td><a href="agdetails.php?sw_id=' . $row["sw_id"] . '">Details</a></td>';
        }
        ?>
